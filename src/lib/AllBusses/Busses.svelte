...
<section
  class="w-full mx-auto bg-midnight-75 px-4 border-t py-4 border-b border-midnight-50"
>
  <div class="flex flex-col gap-2 py-2 max-w-dashboard">
    <div class="text-xl max-w-page w-full mx-auto">
      <h2>Connections between London's busses</h2>
    </div>
