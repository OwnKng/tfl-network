...
<GraphPaper>
  <section class="w-full mx-auto px-4 border-t border-b border-midnight-50">
    <div class="flex flex-col gap-2 py-2 max-w-dashboard">
      <h2 class="text-3xl font-bold max-w-page w-full mx-auto">
        Connectivity of London bus routes
      </h2>
